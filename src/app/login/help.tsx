...
export default function Help() {
	...
	return (
		<KeyboardAvoidingView behavior="padding" style={tw`flex-1`}>
			<View style={tw`flex-1 justify-start items-center bg-white`}>
				<View style={tw`flex flex-col w-full p-5 gap-5`}>
					...
					<View style={tw`flex flex-col gap-4`}>
						...
						<Text style={tw`font-poppins text-sm`}>
							...
							between Wi-Fi and mobile data to see if that resolves the issue.
						</Text>
					</View>
					<View style={tw`h-0.2 w-full bg-gray-400`} />
					<View style={tw`flex flex-col gap-4`}>
						...
						<Text style={tw`font-poppins text-sm`}>
							Using an outdated version of the app can lead to login problems.
							Ensure you have the latest version installed from your
							device&apos;s app store.
						</Text>
					</View>
					<View style={tw`h-0.2 w-full bg-gray-400`} />
					<View style={tw`flex flex-col gap-4`}>
						...
						<Text style={tw`font-poppins text-sm`}>
							If you&apos;re still experiencing issues, please let us know by
							submitting your problem here.
						</Text>
						<TextInput
				...
				<Modal transparent={true} animationType="slide" visible={modalVisible}>
					...
					>
						<View style={tw`bg-white rounded-lg p-5 w-80`}>
							...
							>
								<Text style={tw`text-white font-poppinsSemiBold`}>Close</Text>
							</TouchableOpacity>
						</View>
					</View>
				</Modal>
